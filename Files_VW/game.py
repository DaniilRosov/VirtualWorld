...
class Game:
    def __init__(self, surface):
        ...
        self.background = Background(background_image='background.jpg')
    ...
    def draw(self):
        ...
        # draw the score
        ui.draw_text(self.surface, f"Score : {self.score}", (10, 10), COLORS["score"], font=FONTS["medium"],
                    shadow=True, shadow_color=(255,255,255))
        # draw the time left
        timer_text_color = (160, 40, 0) if self.time_left < 5 else COLORS["timer"] # change the text color if less than 5 s left
        ui.draw_text(self.surface, f"Time left : {self.time_left}", (infoObject.current_w-300, 10),  timer_text_color, font=FONTS["medium"],
                    shadow=True, shadow_color=(255,255,255))
    ...
    def update(self):
        ...
        if self.time_left > 0:
            ...
            if ui.button(self.surface, 540, "Menu", click_sound=self.sounds["slap"]):
                return "menu"
